...
namespace AdminTools
{
	public class Plugin : Plugin<Config>
	{
		...
		private static readonly string OverwatchFilePath = Path.Combine(CacheFilesDirectory, "AdminTools-Overwatch.txt");
		private static readonly string HiddenTagsFilePath = Path.Combine(CacheFilesDirectory, "AdminTools-HiddenTags.txt");
		...
		public override void OnEnabled()
		{
			try
			{
				...
				Handlers.Server.WaitingForPlayers += _eventHandlers.OnWaitingForPlayers;
				Handlers.Player.InteractingDoor += _eventHandlers.OnDoorOpen;
